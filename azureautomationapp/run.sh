...
ACCESS_TOKEN=$(curl --no-progress-meter --silent "$IDENTITY_ENDPOINT?api-version=2019-08-01&client_id=$AZURE_CLIENT_ID&resource=https://management.azure.com/" -H "X-IDENTITY-HEADER: $IDENTITY_HEADER")
